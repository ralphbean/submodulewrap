# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in wrappedapp.
...
from wrappedapp.lib import app_globals, helpers
...
base_config.package = wrappedapp
...
base_config.model = wrappedapp.model
base_config.DBSession = wrappedapp.model.DBSession
